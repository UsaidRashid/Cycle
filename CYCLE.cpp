...
int main()
{
    ...
    initwindow(screenwidth,screenHeight,"USAID",-3);
    ...
    while(1)
    {
        ...
        circle(circle2x,450,50);          //SECOND CIRLE RIGHT SIDE
        
        circle(circle1x,450,49);          //FIRST CIRCLE LEFT SIDE 
        circle(circle2x,450,49);          //SECOND CIRCLE RIGHT SIDE    

        circle(circle1x,450,48);          //FIRST CIRCLE LEFT SIDE
        circle(circle2x,450,48);          //SECOND CIRCLE RIGHT SIDE
        ...
        line(poly_rightline-1,390,poly_rightline-50-1,390);  //RIGHT LINE OF CYCLE
        ...
        if(n==1)
        {
            ...
            line(730,595-1,760,595-1);
            int points2[8]={760,595,750,590,750,600,7780,595};
            fillpoly(4,points2);
        }
